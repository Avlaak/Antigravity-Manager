...
import { RefreshCw, X, Bot, CheckCircle2, AlertTriangle, Globe2, ListChecks } from 'lucide-react';
...
interface HermesSyncModalProps {
    apiKey: string;
    getFormattedProxyUrl: (app: 'Claude' | 'Codex' | 'Gemini' | 'OpenCode' | 'Droid' | 'Hermes') => string;
    onClose: () => void;
    onSyncDone: () => void;
}
